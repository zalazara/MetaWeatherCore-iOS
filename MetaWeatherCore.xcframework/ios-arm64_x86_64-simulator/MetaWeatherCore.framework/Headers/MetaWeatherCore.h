...
@class MWCWeatherApiCompanion, MWCKotlinThrowable, MWCKotlinArray<T>, MWCKotlinException, MWCKotlinRuntimeException, MWCKotlinIllegalStateException;
...
*/
- (void)locationSearchWithCompletionHandler:(void (^)(NSString * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("locationSearch(completionHandler:)")));
@end;
