...
@class MWCWeatherApiCompanion, MWCWeatherLocation, MWCWeatherLocationCompanion, MWCKotlinThrowable, MWCKotlinArray<T>, MWCKotlinException, MWCKotlinRuntimeException, MWCKotlinIllegalStateException, MWCKotlinx_serialization_coreSerializersModule, MWCKotlinx_serialization_coreSerialKind, MWCKotlinNothing;

@protocol MWCKotlinx_serialization_coreKSerializer, MWCKotlinx_serialization_coreEncoder, MWCKotlinx_serialization_coreSerialDescriptor, MWCKotlinx_serialization_coreSerializationStrategy, MWCKotlinx_serialization_coreDecoder, MWCKotlinx_serialization_coreDeserializationStrategy, MWCKotlinIterator, MWCKotlinx_serialization_coreCompositeEncoder, MWCKotlinAnnotation, MWCKotlinx_serialization_coreCompositeDecoder, MWCKotlinx_serialization_coreSerializersModuleCollector, MWCKotlinKClass, MWCKotlinKDeclarationContainer, MWCKotlinKAnnotatedElement, MWCKotlinKClassifier;
...
*/
- (void)locationSearchQuery:(NSString *)query completionHandler:(void (^)(MWCWeatherLocation * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("locationSearch(query:completionHandler:)")));
@end;
